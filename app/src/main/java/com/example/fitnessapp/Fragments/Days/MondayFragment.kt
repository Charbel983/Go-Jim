...
class MondayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val parentHolder = inflater.inflate(R.layout.fragment_monday, container, false)
        val addExercisesButton : FloatingActionMenu = parentHolder.findViewById(R.id.addExerciseButton)
        recyclerView = parentHolder.findViewById(R.id.mondayMainRecyclerView)
        val spinner : Spinner = parentHolder.findViewById(R.id.chosenWorkoutSpinner)
        val swipeRefreshLayout : SwipeRefreshLayout = parentHolder.findViewById(R.id.mondaySwipeRefreshLayout)
        val controller = AllDaysFragmentController("Monday", addExercisesButton, recyclerView, spinner, swipeRefreshLayout, requireActivity(), requireContext())
        controller.start()
