...
class SaturdayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val parentHolder = inflater.inflate(R.layout.fragment_saturday, container, false)
        val addExercisesButton : FloatingActionMenu = parentHolder.findViewById(R.id.addExerciseButton)
        recyclerView = parentHolder.findViewById(R.id.saturdayMainRecyclerView)
        val spinner : Spinner = parentHolder.findViewById(R.id.chosenWorkoutSpinner)
        val swipeRefreshLayout : SwipeRefreshLayout = parentHolder.findViewById(R.id.saturdaySwipeRefreshLayout)
        val controller = AllDaysFragmentController("Saturday", addExercisesButton, recyclerView, spinner, swipeRefreshLayout, requireActivity(), requireContext())
        controller.start()
